...
- [ ] finding coefficients of rational functions
...
- [ ] finding generating series from 
  ...
  - [ ] compositions
- [ ] unambiguous decompositions of a binary string
- [ ] find generating series from decomposition of a binary string
